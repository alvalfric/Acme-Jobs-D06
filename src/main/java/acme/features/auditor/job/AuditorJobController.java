...
public class AuditorJobController extends AbstractController<Auditor, Job> {
	...
	@Autowired
	private AuditorJobListPendingService	listPendingService;

	@Autowired
	private AuditorJobListDoneService		listDoneService;
	...
	private void initialise() {
		super.addCustomCommand(CustomCommand.LIST_DONE, BasicCommand.LIST, this.listDoneService);
