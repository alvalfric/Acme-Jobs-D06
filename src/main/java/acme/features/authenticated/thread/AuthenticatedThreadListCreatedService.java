...
@Service
public class AuthenticatedThreadListCreatedService implements AbstractListService<Authenticated, Thread> {
	...
	public Collection<Thread> findMany(final Request<Thread> request) {
		...
		result = this.repository.findManyByCreatorId(principal.getActiveRoleId());
